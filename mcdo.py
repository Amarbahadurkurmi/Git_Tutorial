...
def validate_cmbox(event):
    df = pd.read_excel('mcdo.xlsx')  # Make sure your file path is correct
...
#      Get data from Entry widgets 
    ...
    try:
            workbook = xl.load_workbook('mcdo.xlsx')
...
tk.Label(win,text='MCDO ENTRY FORM',font=('New Times Roman',20,'bold'),relief=GROOVE,padx=10,
...
tk.Label(stnlable,text='Batch Name ',font=('Times New Roman',12,'bold'),
